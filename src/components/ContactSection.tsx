      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto">
            Come experience the full Dulceria Medina magic in person!
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="bg-card rounded-xl border border-border p-6 text-center hover:shadow-fiesta transition-shadow">
            ...
            <h3 className="font-fredoka text-lg text-foreground mb-2">Address</h3>
          ...
          <div className="bg-card rounded-xl border border-border p-6 text-center hover:shadow-fiesta transition-shadow">
            ...
            <h3 className="font-fredoka text-lg text-foreground mb-2">Hours</h3>
            <p className="text-muted-foreground text-sm">
          ...
          <div className="bg-card rounded-xl border border-border p-6 text-center hover:shadow-fiesta transition-shadow">
            ...
            <h3 className="font-fredoka text-lg text-foreground mb-2">Contact</h3>
